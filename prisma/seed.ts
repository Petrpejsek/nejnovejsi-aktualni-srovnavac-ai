...
async function main() {
  try {
    // Nejdřív vymažeme všechny existující produkty
    await prisma.product.deleteMany({});
    console.log('Vymazány všechny existující produkty');
    ...
    const newProducts = [
      ...
      {
        name: 'Midjourney',
        description: 'AI nástroj pro generování uměleckých obrazů',
        price: 10,
        category: 'Generování obrázků',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Midjourney',
        tags: JSON.stringify(['AI', 'Generování obrázků', 'Umění']),
        advantages: JSON.stringify(['Vysoká kvalita', 'Umělecký styl', 'Komunita']),
        disadvantages: JSON.stringify(['Pouze Discord', 'Čekací doba', 'Omezený počet generování']),
        detailInfo: 'Midjourney je špičkový AI nástroj pro generování uměleckých obrazů. Nabízí unikátní umělecký styl a vysokou kvalitu výstupů.',
        pricingInfo: JSON.stringify({
          basic: '10',
          pro: '30',
          enterprise: '60'
      ...
      },
      {
        ...
        advantages: JSON.stringify(['Zdarma', 'Vlastní hosting', 'Přizpůsobitelnost']),
        disadvantages: JSON.stringify(['Technická náročnost', 'Vyšší nároky na hardware', 'Složitější nastavení']),
        detailInfo: 'Stable Diffusion je open-source model pro generování obrázků, který můžete provozovat lokálně nebo v cloudu.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '0',
          enterprise: 'Custom'
      ...
      {
        name: 'DALL-E',
        description: 'AI systém pro generování obrázků od OpenAI',
        price: 15,
        category: 'Generování obrázků',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=DALL-E',
        tags: JSON.stringify(['AI', 'Generování obrázků', 'OpenAI']),
        advantages: JSON.stringify(['Přesnost', 'Intuitivní rozhraní', 'Editace']),
        disadvantages: JSON.stringify(['Cena za kredit', 'Omezení stylu', 'Občas nepřesné']),
        detailInfo: 'DALL-E je pokročilý AI systém od OpenAI pro generování a editaci obrázků na základě textového popisu.',
        pricingInfo: JSON.stringify({
          basic: '15',
          pro: '50',
          enterprise: '120'
        ...
        videoUrls: JSON.stringify([]),
        externalUrl: 'https://openai.com/dall-e-2',
        hasTrial: true
      },
      {
        name: 'ChatGPT',
        description: 'Pokročilý AI chatbot od OpenAI',
        price: 20,
        category: 'AI Asistent',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=ChatGPT',
        tags: JSON.stringify(['AI', 'Chatbot', 'OpenAI']),
        advantages: JSON.stringify(['Všestrannost', 'Přirozená konverzace', 'Znalostní báze']),
        disadvantages: JSON.stringify(['Občasné nepřesnosti', 'Omezení kontextu', 'Cena']),
        detailInfo: 'ChatGPT je revoluční AI chatbot, který dokáže vést přirozenou konverzaci a pomáhat s různými úkoly.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '20',
          enterprise: 'Custom'
      ...
      {
        name: 'Claude',
        description: 'AI asistent od Anthropic',
        price: 20,
        category: 'AI Asistent',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Claude',
        tags: JSON.stringify(['AI', 'Asistent', 'Anthropic']),
        advantages: JSON.stringify(['Bezpečnost', 'Dlouhý kontext', 'Přesnost']),
        disadvantages: JSON.stringify(['Vyšší cena', 'Méně funkcí', 'Omezená dostupnost']),
        detailInfo: 'Claude je AI asistent zaměřený na bezpečnost a přesnost, vhodný pro profesionální použití.',
        pricingInfo: JSON.stringify({
          basic: '20',
          pro: '60',
          enterprise: 'Custom'
        ...
        videoUrls: JSON.stringify([]),
        externalUrl: 'https://www.anthropic.com/claude',
        hasTrial: true
      },
      {
        name: 'Gemini',
        description: 'Multimodální AI model od Google',
        price: 10,
        category: 'AI Asistent',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Gemini',
        tags: JSON.stringify(['AI', 'Multimodální', 'Google']),
        advantages: JSON.stringify(['Multimodální vstupy', 'Integrace s Google', 'Výkon']),
        disadvantages: JSON.stringify(['Nový produkt', 'Omezená dostupnost', 'Méně funkcí']),
        detailInfo: 'Gemini je pokročilý AI model od Google, který dokáže pracovat s textem, obrázky a dalšími typy dat.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '10',
          enterprise: 'Custom'
        ...
        videoUrls: JSON.stringify([]),
        externalUrl: 'https://deepmind.google/technologies/gemini/',
        hasTrial: true
      },
      {
        name: 'Copilot',
        description: 'AI asistent pro programování od GitHub',
        price: 10,
        category: 'Programování',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Copilot',
        tags: JSON.stringify(['AI', 'Programování', 'GitHub']),
        advantages: JSON.stringify(['Integrace s IDE', 'Kvalita kódu', 'Produktivita']),
        disadvantages: JSON.stringify(['Měsíční předplatné', 'Občas nepřesné', 'Závislost na kontextu']),
        detailInfo: 'GitHub Copilot je AI pair programmer, který pomáhá s psaním kódu a zvyšuje produktivitu vývojářů.',
        pricingInfo: JSON.stringify({
          basic: '10',
          pro: '19',
          enterprise: '39'
      ...
      {
        name: 'Codeium',
        description: 'AI asistent pro programování s důrazem na soukromí',
        price: 0,
        category: 'Programování',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Codeium',
        tags: JSON.stringify(['AI', 'Programování', 'Soukromí']),
        advantages: JSON.stringify(['Zdarma', 'Soukromí', 'Více IDE']),
        disadvantages: JSON.stringify(['Méně funkcí', 'Menší komunita', 'Omezená podpora']),
        detailInfo: 'Codeium je alternativní AI asistent pro programování s důrazem na soukromí a bezpečnost.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '15',
          enterprise: '30'
      ...
      {
        name: 'Tabnine',
        description: 'AI asistent pro programování s lokálním modelem',
        price: 12,
        category: 'Programování',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Tabnine',
        tags: JSON.stringify(['AI', 'Programování', 'Lokální model']),
        advantages: JSON.stringify(['Lokální běh', 'Soukromí', 'Rychlost']),
        disadvantages: JSON.stringify(['Nároky na hardware', 'Omezený kontext', 'Cena']),
        detailInfo: 'Tabnine nabízí AI asistenci při programování s možností běhu lokálního modelu pro maximální soukromí.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '12',
          enterprise: '25'
      ...
      {
        name: 'Cursor',
        description: 'AI-powered vývojové prostředí',
        price: 20,
        category: 'Programování',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Cursor',
        tags: JSON.stringify(['AI', 'IDE', 'Programování']),
        advantages: JSON.stringify(['Integrovaná AI', 'Moderní rozhraní', 'Chat']),
        disadvantages: JSON.stringify(['Nový produkt', 'Omezené funkce', 'Stabilita']),
        detailInfo: 'Cursor je moderní vývojové prostředí s integrovanou AI pro efektivnější programování.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '20',
          enterprise: '40'
      ...
      {
        name: 'Replit',
        description: 'Online vývojové prostředí s AI funkcemi',
        price: 10,
        category: 'Programování',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Replit',
        tags: JSON.stringify(['AI', 'IDE', 'Cloud']),
        advantages: JSON.stringify(['Online přístup', 'Spolupráce', 'AI asistence']),
        disadvantages: JSON.stringify(['Závislost na internetu', 'Omezení free verze', 'Výkon']),
        detailInfo: 'Replit je cloudové vývojové prostředí s integrovanou AI asistencí a možností spolupráce.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '10',
          enterprise: '25'
      ...
      {
        name: 'Notion AI',
        description: 'AI asistent pro práci s dokumenty',
        price: 10,
        category: 'Produktivita',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Notion+AI',
        tags: JSON.stringify(['AI', 'Dokumenty', 'Produktivita']),
        advantages: JSON.stringify(['Integrace s Notion', 'Všestrannost', 'Jednoduchost']),
        disadvantages: JSON.stringify(['Nutnost Notion', 'Cena', 'Omezení']),
        detailInfo: 'Notion AI je integrovaný asistent pro platformu Notion, který pomáhá s psaním a organizací obsahu.',
        pricingInfo: JSON.stringify({
          basic: '10',
          pro: '20',
          enterprise: '40'
      ...
      {
        name: 'Mem.ai',
        description: 'AI poznámkový systém',
        price: 15,
        category: 'Produktivita',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Mem.ai',
        tags: JSON.stringify(['AI', 'Poznámky', 'Produktivita']),
        advantages: JSON.stringify(['AI organizace', 'Vyhledávání', 'Integrace']),
        disadvantages: JSON.stringify(['Učící křivka', 'Cena', 'Komplexnost']),
        detailInfo: 'Mem.ai je pokročilý poznámkový systém s AI, který automaticky organizuje a propojuje informace.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '15',
          enterprise: '30'
      ...
      {
        name: 'Taskade',
        description: 'AI platforma pro týmovou spolupráci',
        price: 8,
        category: 'Produktivita',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Taskade',
        tags: JSON.stringify(['AI', 'Spolupráce', 'Produktivita']),
        advantages: JSON.stringify(['Všestrannost', 'Týmové funkce', 'AI asistence']),
        disadvantages: JSON.stringify(['Přehlcené rozhraní', 'Učící křivka', 'Omezení free verze']),
        detailInfo: 'Taskade kombinuje projektové řízení, dokumenty a chat s AI asistencí pro efektivní týmovou spolupráci.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '8',
          enterprise: '20'
        ...
        videoUrls: JSON.stringify([]),
        externalUrl: 'https://www.taskade.com',
        hasTrial: true
      },
      {
        name: 'Otter.ai',
        description: 'AI transkripce a poznámky ze schůzek',
        price: 10,
        category: 'Produktivita',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Otter.ai',
        tags: JSON.stringify(['AI', 'Transkripce', 'Schůzky']),
        advantages: JSON.stringify(['Přesnost', 'Integrace', 'Automatické shrnutí']),
        disadvantages: JSON.stringify(['Cena za minutu', 'Omezení jazyků', 'Online only']),
        detailInfo: 'Otter.ai automaticky vytváří přepisy a poznámky ze schůzek s pomocí AI.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '10',
          enterprise: '25'
      ...
      {
        name: 'Fireflies.ai',
        description: 'AI asistent pro schůzky a poznámky',
        price: 10,
        category: 'Produktivita',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Fireflies.ai',
        tags: JSON.stringify(['AI', 'Schůzky', 'Poznámky']),
        advantages: JSON.stringify(['Automatizace', 'Integrace', 'Analýza']),
        disadvantages: JSON.stringify(['Měsíční limit', 'Cena', 'Závislost na internetu']),
        detailInfo: 'Fireflies.ai automaticky zaznamenává, přepisuje a analyzuje schůzky pomocí AI.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '10',
          enterprise: '30'
      ...
      {
        name: 'Krisp',
        description: 'AI potlačení šumu pro videohovory',
        price: 8,
        category: 'Audio',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Krisp',
        tags: JSON.stringify(['AI', 'Audio', 'Videohovory']),
        advantages: JSON.stringify(['Kvalita zvuku', 'Jednoduchost', 'Integrace']),
        disadvantages: JSON.stringify(['Využití CPU', 'Cena', 'Občasné artefakty']),
        detailInfo: 'Krisp používá AI pro odstranění rušivých zvuků během videohovorů.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '8',
          enterprise: '20'
        ...
        videoUrls: JSON.stringify([]),
        externalUrl: 'https://krisp.ai',
        hasTrial: true
      },
      {
        name: 'Descript',
        description: 'AI editor videa a audia',
        price: 12,
        category: 'Video',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Descript',
        tags: JSON.stringify(['AI', 'Video', 'Audio']),
        advantages: JSON.stringify(['Intuitivní', 'Pokročilé funkce', 'Kvalita']),
        disadvantages: JSON.stringify(['Nároky na hardware', 'Učící křivka', 'Cena']),
        detailInfo: 'Descript je revoluční editor videa a audia s AI funkcemi pro snadnou úpravu obsahu.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '12',
          enterprise: '30'
      ...
      {
        name: 'Runway',
        description: 'AI nástroje pro video editaci',
        price: 15,
        category: 'Video',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Runway',
        tags: JSON.stringify(['AI', 'Video', 'Editace']),
        advantages: JSON.stringify(['Pokročilé efekty', 'Generativní funkce', 'Kvalita']),
        disadvantages: JSON.stringify(['Vysoká cena', 'Složitost', 'Nároky na hardware']),
        detailInfo: 'Runway nabízí pokročilé AI nástroje pro profesionální video editaci a vizuální efekty.',
        pricingInfo: JSON.stringify({
          basic: '15',
          pro: '35',
          enterprise: '70'
      ...
      },
      {
        ...
        price: 16,
        category: 'Video',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Kapwing',
        tags: JSON.stringify(['AI', 'Video', 'Online']),
        advantages: JSON.stringify(['Dostupnost', 'Spolupráce', 'Jednoduchost']),
        disadvantages: JSON.stringify(['Omezení free verze', 'Online only', 'Méně funkcí']),
        detailInfo: 'Kapwing je online video editor s AI funkcemi, dostupný přímo v prohlížeči.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '16',
          enterprise: '35'
      ...
      {
        name: 'Canva',
        description: 'Online grafický editor s AI funkcemi',
        price: 13,
        category: 'Design',
        imageUrl: 'https://placehold.co/800x450/f3f4f6/94a3b8?text=Canva',
        tags: JSON.stringify(['AI', 'Design', 'Grafika']),
        advantages: JSON.stringify(['Jednoduchost', 'Šablony', 'Všestrannost']),
        disadvantages: JSON.stringify(['Omezená customizace', 'Základní nástroje', 'Závislost na šablonách']),
        detailInfo: 'Canva je populární online grafický editor s integrovanými AI funkcemi pro snadnou tvorbu designu.',
        pricingInfo: JSON.stringify({
          basic: '0',
          pro: '13',
          enterprise: '30'
    ...
    console.log(`Celkem produktů k přidání: ${newProducts.length}`);
    
    let successCount = 0;
    let errorCount = 0;

    // Přidáme každý produkt zvlášť
    for (const product of newProducts) {
      try {
        ...
        successCount++;
        console.log(`✓ Přidán produkt ${successCount}: ${product.name}`);
      } catch (error) {
        errorCount++;
        console.error(`✗ Chyba při přidávání produktu ${product.name}:`, error);
      }
    }

    console.log(`\nSeed dokončen!`);
    console.log(`Úspěšně přidáno: ${successCount} produktů`);
    if (errorCount > 0) {
      console.log(`Chyby při přidávání: ${errorCount} produktů`);
    }
  } catch (error) {
    console.error('Hlavní chyba při seedování:', error);
    throw error;
  }
}
