...
async function updateAssistant() {
  ...
  try {
    ...
    Tvoje odpověď musí být výhradně v JSON formátu, bez jakéhokoliv dalšího textu (žádné nadpisy, žádný Markdown, žádné komentáře, žádné úvodní věty).
    ...
    DŮLEŽITÉ:
    - ID každého nástroje musí odpovídat přesně tomu, které je uvedeno v databázi.
...
updateAssistant()
  .then(assistantId => {
    ...
    console.log('Pro otestování asistenta spusťte: node test-assistant.js');
  })
  .catch(error => {
    console.error('Chyba při aktualizaci asistenta:', error);
  }); 