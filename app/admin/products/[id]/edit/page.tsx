...
// Simplified upload function - replace lines 328-407 in edit/page.tsx
...
const handleImageUpload = async (file: File) => {
  ...
  try {
    ...
    setErrorMessage(`Chyba při nahrávání: ${error instanceof Error ? error.message : 'Neznámá chyba'}`)
